...
HCAL_Isolation = PSet(
    ...
    linestyles = ["-", "-"],
    markers = ["", ""],
    datafile = "data/HCAL_Isolation.txt",
...
Track_Isolation = PSet(
    ...
    linestyles = ["-", "-"],
    markers = ["", ""],
    datafile = "data/Track_Isolation.txt",
...
Hadronic_Over_EM = PSet(
    ...
    linestyles = ["-", "-"],
    markers = ["", ""],
    datafile = "data/Hadronic_Over_EM.txt",
...
nVertices = PSet(
    ...
    linestyles = ["", ""],
    markers = ["", "o"],
    datafile = "data/nVertices.txt",
    name = "plots/nVertices",
    xlabel = r"Number of Vertices",
    ylabel = r"fraction of events"
)
...
Data_MC_MET = PSet(
    ...
    linestyles = ["", ""],
    markers = ["", "o"],
    datafile = "data/Data_MC_MET.txt",
    name = "plots/Data_MC_MET",
    xlabel = r"$\slashed{E}_{T}$ (GeV)",
    ylabel = r"fraction of events"
)
...
Data_MC_HT = PSet(
    ...
    linestyles = ["", ""],
    markers = ["", "o"],
    datafile = "data/Data_MC_HT.txt",
    name = "plots/Data_MC_HT",
    xlabel = r"$H_{T}$ (GeV)",
    ylabel = r"fraction of events"
)
